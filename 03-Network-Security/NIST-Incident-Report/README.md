...
## 🎯 Incident Summary
The organization experienced a **Denial of Service (DoS)** attack that compromised the internal network for two hours. The attack utilized a flood of **ICMP packets** to overwhelm network resources, causing services to stop responding to legitimate traffic.
